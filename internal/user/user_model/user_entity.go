...
func (u *User) ToS2C_Login() *S2C_Login {
	return &S2C_Login{
		UserID:   u.ID.Value(),
...
func (u *User) ToS2C_UserInfo() *S2C_UserInfo {
	return &S2C_UserInfo{
		UserID:   u.ID.Value(),
		Username: u.Username.Value(),
...
func (u *User) ToS2G_UserInfo() *user_pb.S2G_UserInfo {
	return &user_pb.S2G_UserInfo{
		User: &user_pb.UserDTO{
			Id:       u.ID.Value(),
			Username: u.Username.Value(),
		},
	}
